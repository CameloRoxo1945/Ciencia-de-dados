...
async function visualizarInformacoesGlobias(){
    ...
    const trabalhadoreMundo = (dados.total_trabalhadores_mundo/1e9)
    const temposDeTrabalho = (dados.tempo_medio_deslocamento_para_trabalho)
    const minutos =Math. round((dados.tempo_medio_deslocamento_para_trabalho - temposDeTrabalho) * 60 )
